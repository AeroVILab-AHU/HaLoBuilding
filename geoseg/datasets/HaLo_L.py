...
class HaLo_LTrainDataset(Dataset):
    def __init__(self, data_root='/data/sff/LWGANet-main/segmentation/data/HaLo_L/train_val', img_dir='img', mosaic_ratio=0.25,
...
HaLo_L_val_dataset = HaLo_LTrainDataset(data_root='/data/sff/LWGANet-main/segmentation/data/HaLo_L/val', mosaic_ratio=0.0,
                                        transform=val_aug)
class HaLo_LTestDataset(Dataset):
    def __init__(self, data_root='/data/sff/LWGANet-main/segmentation/data/HaLo_L/test', img_dir='img',
